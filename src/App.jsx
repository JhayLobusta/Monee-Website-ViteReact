...
<section className='sm:py-32 border-t border-gray-200'>
    ...
    <div class="group relative flex-col">
        ...
        <h3 class="text-lg font-semibold leading-6 text-gray-900 ">
          ...
          <a class="relative z-10 rounded-full px-3 py-1.5 text-slate-50 bg-red-400">Usage</a>
      ...
      <div class="group relative flex-col">
        ...
        <h3 class="text-lg font-semibold leading-6 text-gray-900 ">
          ...
          <a class="relative z-10 rounded-full px-3 py-1.5 text-slate-50 bg-cyan-500">Feature</a>
        </div>
      ...
      <div class="group relative flex-col">
        ...
        <h3 class="text-lg font-semibold leading-6 text-gray-900 ">
          ...
          <a class="relative z-10 rounded-full px-3 py-1.5 text-slate-50 bg-violet-400">Design</a>
        </div>
      ...
      <article class="flex max-w-xl flex-row items-start justify-between gap-x-8 ">
        ...
        <h3 class="text-lg font-semibold leading-6 text-gray-900 ">
          ...
          <a class="relative z-10 rounded-full px-3 py-1.5 text-slate-50 bg-amber-400">Price</a>
        </div>
          
          <p class="mt-5 ml-10 line-clamp-3 text-md leading-6 text-gray-600">Monee is not only affordable, but it's also ad-free. No interruptions, just a seamless and focused experience as you take control of your finances.</p>
        </div>
      </article>
    </div>
</section>
