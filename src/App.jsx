...
const App = () => {
  return (
    <>
    <div className=' mx-6 pt-12 max-w-screen-xl sm:mx-10 md:mx-10 lg:mx-16 xl:24 2xl:mx-auto'>
...
<section className="flex sm:flex-col md:flex-col lg:flex-row xl:flex-row 2xl:flex-row items-center gap-8 sm:gap-0 md:gap-0 mt-24">
  {/* Hero Left column */}
  <div className="flex-1 space-y-12">
    ...
    <div className="flex sm:flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row space-x-0 sm:space-x-0 md:space-x-8 lg:space-x-8 xl:space-x-8 2xl:space-x-8 space-y-0 sm:space-y-8 md:space-y-0 lg:space-y-0 xl:space-y-0 2xl:space-y-0">
      <a href="#" className="button-container">
        <div className="overlay bg-gradient-to-r w-auto h-16 sm:w-auto md:w-56 lg:w-56 transition-all ease-in-out from-slate-950 to-slate-950 hover:from-slate-950 hover:to-lime-700"><svg className='w-6 h-6 mr-2' xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path fill="#ffffff" d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z"/></svg>Coming Soon</div>
      </a>
      <a href="#" className="button-container">
  ...
  <div className="flex-1 text-left flex items-center justify-center">
            <div className="circle-back bg-slate-100"></div>
            <div className="circle-front bg-slate-300">
...
<section className='sm:py-32 border-t border-gray-200'>
    ...
    <div class="mx-auto grid max-w-3xl grid-cols-1 gap-x-2 gap-y-16 sm:mt-14 sm:pt-14 sm:grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2 ">
    ...
    <div class="group relative flex-col">
        ...
        <h3 class="text-lg font-semibold leading-6 text-gray-900 ">
          ...
          <a class="relative rounded-full px-3 py-1.5 text-slate-50 bg-red-400">Usage</a>
      ...
      <div class="group relative flex-col">
        ...
        <h3 class="text-lg font-semibold leading-6 text-gray-900 ">
          ...
          <a class="relative rounded-full px-3 py-1.5 text-slate-50 bg-cyan-500">Feature</a>
        </div>
      ...
      <div class="group relative flex-col">
        ...
        <h3 class="text-lg font-semibold leading-6 text-gray-900 ">
          ...
          <a class="relative rounded-full px-3 py-1.5 text-slate-50 bg-violet-400">Design</a>
        </div>
      ...
      <article class="flex max-w-xl flex-row items-start justify-between gap-x-8 ">
        ...
        <h3 class="text-lg font-semibold leading-6 text-gray-900 ">
          ...
          <a class="relative rounded-full px-3 py-1.5 text-slate-50 bg-amber-400">Price</a>
        </div>
...
<section className="flex items-center gap-8 border-t border-gray-200 pt-20 pb-10">
<div className="flex-1 text-left flex items-center justify-center">
            <div className="circle-back-small bg-slate-100"></div>
            <div className="circle-front-small bg-slate-300">
